      ...
      <el-form-item label="广告">
        ...
        <el-row type="flex" style="flex-wrap: wrap">
          <el-col :md="24" v-for="(item,i) in model.items" :key="i">
            <el-form-item label="跳转连接(URL)" style="flex-wrap: wrap">
              <el-input v-model="item.name"></el-input>
            </el-form-item>
            <el-form-item label="图片" style="flex-wrap: wrap;margin-top: 10px" >
              <el-upload
              ...
              >
                <img v-if="item.image" :src="item.image" class="avatar" :alt="model.name">
